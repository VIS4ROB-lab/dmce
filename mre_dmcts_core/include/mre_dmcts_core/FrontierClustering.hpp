...
#include "mre_dmcts_msgs/FrontierClusters.h"
...
namespace mre_dmcts {
	...
	public:
		 ...
		 */
		mre_dmcts_msgs::FrontierClusters getMessage() const;

		/**
		 * Reads contents of a FrontierClusters message.
		 */
		void fromMessage(const mre_dmcts_msgs::FrontierClusters& message);
