...
#include "mre_dmcts_sim/PathPlanner.hpp"
#include "mre_dmcts_core/RobotMap.hpp"

namespace mre_dmcts_test {

	class DummyPathPlanner : public mre_dmcts::PathPlanner {
	public:
		using mre_dmcts::PathPlanner::PathPlanner;

		bool move(const double& timeStep, mre_dmcts::pos_t& position) override {
