...
protected:
	...
	mre_dmcts::RobotMap robotMap;
	mre_dmcts::RobotMap otherMap;
...
TEST_F(TestRobotMap, IsFrontierCell) {
	...
	mre_dmcts::pos_t pos; robotMap.getPosition(idx, pos);
...
TEST_F(TestRobotMap, OnOneFreeCell_GetFrontier_SizeOne) {
	mre_dmcts::indexList_t frontier = robotMap.getFrontier();
...
TEST_F(TestRobotMap, mergeMap_unknownPrior) {
	...
	mre_dmcts::pos_t occPos{.5,0};
	mre_dmcts::pos_t freePos{.5,1};
...
TEST_F(TestRobotMap, mergeMap_freePrior) {
	...
	mre_dmcts::pos_t occPos = {0,1};
	mre_dmcts::pos_t freePos = {0,.5};
...
TEST_F(TestRobotMap, mergeMap_occupiedPrior) {
	...
	mre_dmcts::pos_t unknPos = {1,.5};
	mre_dmcts::pos_t freePos = {1,0};
