...
#include "mre_dmcts_msgs/RobotConnectivity.h"
...
protected:
	...
	mre_dmcts::RobotConnectivity connectivity;
...
TEST_F(TestRobotConnectivity, CheckLayout) {
	mre_dmcts::RobotConnectivity::Message msg = connectivity.getMessage();
...
TEST_F(TestRobotConnectivity, CheckMessageConstructor) {
	...
	mre_dmcts::RobotConnectivity::Message msg = connectivity.getMessage();
	mre_dmcts::RobotConnectivity copy(msg);
