...
#include "mre_dmcts_msgs/RobotMapUpdate.h"
...
protected:
	...
	std::unique_ptr<mre_dmcts::GlobalMapServer> mapServer;
...
public:
	TestGlobalMapServer() {
		...
		updatePublisher =
			ros::NodeHandle().advertise<mre_dmcts_msgs::RobotMapUpdate>(
	...
	void publishUpdate() {
		mre_dmcts_msgs::RobotMapUpdate message;
		message.length = 4;
