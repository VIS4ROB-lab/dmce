...
namespace mre_dmcts {
	...
	mre_dmcts_msgs::GetStartingArea::Response NodeServer::fetchStartingArea_(const double& timeout) {
		ros::ServiceClient client = nodeHandle_.serviceClient<mre_dmcts_msgs::GetStartingArea>(
		...
		mre_dmcts_msgs::GetStartingArea area_msg;
	...
	GroundTruthMap NodeServer::fetchGroundTruthMap_(const double& timeout) {
		ros::ServiceClient client = nodeHandle_.serviceClient<mre_dmcts_msgs::GetMap>(
