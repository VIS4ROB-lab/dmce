...
namespace mre_dmcts {
	...
	void PathfindingServer::update_(ros::Duration timeStep) {
		...
		if (distanceToGoal < navigationCutoff_) {
			mre_dmcts_msgs::PathfindingResult result;
			actionServer_.setSucceeded(result);
			return;
		}

		mre_dmcts_msgs::PathfindingFeedback feedbackMsg;
	...
	void PathfindingServer::positionCallback_(const mre_dmcts_msgs::RobotPosition& msg) {
