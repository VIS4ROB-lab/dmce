...
namespace mre_dmcts {
	...
	bool GroundTruthMapServer::groundTruthMapCallback_(
		mre_dmcts_msgs::GetMap::Request& request,
		mre_dmcts_msgs::GetMap::Response& response)
	{
	...
	bool GroundTruthMapServer::startingAreaCallback_(
		mre_dmcts_msgs::GetStartingArea::Request& request,
		mre_dmcts_msgs::GetStartingArea::Response& response)
	{
